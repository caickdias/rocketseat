#App for scheduling meetings and playing together via Discord using Expo
...
It has nice features like login with Discord account, api fetching for looking into your discords servers and sending invites. Also, we used hooks, API context, fonts importing, navigation, routing and a lot componentizing, folder structure concepts and more. Still has some minor bugs.
